...
- Receive compatibility advice for fish, plants, and invertebrates
- Log maintenance activities and set reminders
- Troubleshoot common aquarium problems

The App is provided as a tool for informational and hobbyist purposes only.
...
- Not interfere with the App's operation or infrastructure
- Not use the App to distribute malware or harmful content
- Not scrape, harvest, or collect data from the App by automated means
...
The App may integrate with or link to third-party services. We are not responsible for the content, policies, or practices of third-party services. Your use of third-party services is subject to their respective terms and policies.
...
- We may delete your account and data in accordance with our [Privacy Policy]({{ '/privacy-policy' | relative_url }}) and [Data Protection]({{ '/data-protection' | relative_url }}) policies
